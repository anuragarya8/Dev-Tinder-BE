...
const userSchema = new mongoose.Schema({
    ...
    password: {
        type: String,
        required: true,
        validate: [validator.isStrongPassword, "Password is not strong enough. It shoul contain at least one uppercase letter, one lowercase letter, one number, one special character, and be at least 8 characters long"]
    },
    photoUtl: {
        type: String,
